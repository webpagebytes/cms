...
public class GaeWBUriCache implements WBUriCache, WBRefreshableCache {
	
	private static final Logger log = Logger.getLogger(GaeWBUriCache.class.getName());

...
*/
	...
	public void testProcessRequest()
	{
		try
		{
			...
			EasyMock.expect(operationsReader.operationToMethod("/test", "GET")).andReturn( new Pair<String,String>("com.webpagebytes.cms.TestDefaultController", "test"));
			EasyMock.expect(operationsReader.operationToMethod("/test", "GET")).andReturn( new Pair<String,String>("com.webpagebytes.cms.TestDefaultController", "test"));
			...
			TestDefaultController controller = (TestDefaultController) ajaxProcessor.getController("com.webpagebytes.cms.TestDefaultController");

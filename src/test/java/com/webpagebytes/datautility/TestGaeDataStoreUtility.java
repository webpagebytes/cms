...
import com.webpagebytes.cms.DummyClientK;
import com.webpagebytes.cms.DummyClientL;
import com.webpagebytes.cms.DummyClientS;
import com.webpagebytes.cms.DummyPrivateClientL;
import com.webpagebytes.cms.DummyPrivateClientS;
import com.webpagebytes.datautility.*;
...
public class TestGaeDataStoreUtility{
	...
	public void testobjectFromEntity_OK_keyString()
	{
		try
		{
			...
			DummyClientS client = (DummyClientS) gaeUtility.objectFromEntity(entity, Class.forName("com.webpagebytes.cms.DummyClientS"));
	...
	public void testobjectFromEntity_OK_keyLong()
	{
		try
		{
			...
			DummyClientL client = (DummyClientL) gaeUtility.objectFromEntity(entity, Class.forName("com.webpagebytes.cms.DummyClientL"));
			assertTrue (client.getAge().compareTo((Integer)properties.get("age"))==0);
			assertTrue (client.getName().compareTo( (String) properties.get("name")) == 0);
			assertTrue (client.getBalance().compareTo((Long) properties.get("balance"))==0);
			assertTrue (client.getBinary() == (Byte) properties.get("binary"));
	...
	public void testobjectFromEntity_privateMembers()
	{
		try
		{
			...
			DummyPrivateClientS client = (DummyPrivateClientS) gaeUtility.objectFromEntity(entity, Class.forName("com.webpagebytes.cms.DummyPrivateClientS"));
		} catch (Exception e)
		{
			assertTrue (false);
		}
